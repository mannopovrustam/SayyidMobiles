            ...
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <h4 class="mb-0">Ombor <u>{{ \Modules\Stock\Entities\Stock::find($stock_id) ? \Modules\Stock\Entities\Stock::find($stock_id)->name : null }}</u>::<a
                            href="/invoices?type=cash"><span
                                class="text-primary">Naqd savdo</span></a></h4>
...
{{--                                                                           wire:change="second_currency_payF()"--}}
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="mb-3 position-relative">
                                                            <label class="col-form-label-sm"
                                                                   for="validationTooltip02">Chegirma {{ $main_currency ? $main_currency->currency : null }}
                                                                                        ...
                                                                                        <table id="datatable"
                                                                                            ...
                                                                                            @foreach(\Modules\Product\Entities\Product::where([['shipment_id', $cp->id],['stock_id', $stock_id],['order_id', null]])->get() as $product)
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>{{ (double)\Modules\Stock\Entities\StockMark::where([['price_type_id', $price_type], ['mark_id', $product->mark_id]])->first()->price }}</td>
                                                                                                    @endif
                                                                                                </tr>
                                                                                            @endforeach
                                                                                            </tbody>
